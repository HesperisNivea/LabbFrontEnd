const salad1 = {name:"ExtraSalad" ,type:"salad", ingredients:[ "ris", "salad", "majs", "sås"], price: 140, description: "Bra salad", img:'C:\Users\radom\OneDrive\Dokumenty\GitHub\LabbFrontEnd\Images\test.jpg'};
...
for (const salad of saladList) {
    ...
    <div class="card h-100">
      <img src="../Images/test.jpg" alt="salad" />
      <div class="card-body">
